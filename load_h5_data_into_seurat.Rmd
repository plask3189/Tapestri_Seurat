...
#Demonstrates the processing pipeline for one sample
...
We do this by comparing empty vs not cells, so we work with the all_barcodes section of the h5 file which includes the empty cells rather than the assay section 
